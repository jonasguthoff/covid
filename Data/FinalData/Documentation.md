...
- the data for daily covid cases and deaths come from the Our World in Data repository, whichand stem originally from the John Hopkins University (full_data.csv)

- the data on first and second dose vaccinations is from the Our World in Data, vaccinations folder. For the US the data comes from the CDC.


For the first and second dose, we take the number of people_fully_vaccinated on a given day and subtract with the number from the previous day to obtain an estimate of the number of second doses given on that day. We then subtract the number of second doses from the total number of doses give to obtain the total number of first doses given.
...
## Documentation from the data folders:

################################################################################
## Copied from the OurWorldinData/vaccinations/README.md
